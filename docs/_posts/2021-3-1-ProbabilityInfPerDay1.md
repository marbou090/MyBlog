...
(1) このサイコロを１個投げるときの確率空間を求めよ。 
  ...
  \begin{equation}
       \mathscr F = \\\{ \emptyset,\\\{ 0 \\\},\\\{ 1\\\},\\\{ 2\\\},\\\{ 3\\\},\\\{ 4\\\},\\\{ 5\\\},\\\{ 6\\\},\cr
      \\\{ 1,2\\\},\\\{ 1,3\\\},\\\{ 1,4\\\},\\\{ 1,5\\\},\\\{ 1,6\\\},\\\{ 2,3\\\},\\\{ 2,4\\\},\\\{ 2,5\\\},\\\{ 2,6\\\},\cr
      \\\{ 3,4\\\},\\\{ 3,5\\\},\\\{ 3,6\\\},\\\{ 4,5\\\},\\\{ 4,6\\\},\\\{ 5,6\\\},\cr
      \\\{ 1,2,3\\\},\\\{ 1,2,3\\\},\\\{ 1,2,4\\\},\\\{ 1,2,5\\\},\\\{ 1,2,6\\\},\\\{ 1,3,4\\\},\\\{ 1,3,5\\\},\\\{ 1,3,6\\\},\cr
      \\\{ 1,4,5\\\},\\\{ 1,4,6\\\},\\\{ 1,5,6\\\},\cr
      \\\{ 2,3,4\\\},\\\{ 2,3,5\\\},\\\{ 2,3,6\\\},\\\{ 2,4,5\\\},\\\{ 2,4,6\\\},\\\{ 2,5,6\\\},\cr
      \\\{ 3,4,5\\\},\\\{ 3,4,6\\\},\\\{ 3,5,6\\\},\\\{ 4,5,6\\\},\cr
      \\\{ 1,2,3,4\\\},\\\{ 1,2,3,5\\\},\\\{ 1,2,3,6\\\},\\\{ 1,2,4,5\\\},\\\{ 1,2,4,6\\\},\\\{ 1,3,4,5\\\},\\\{ 1,3,4,6\\\},\cr
      \\\{ 1,4,5,6\\\},\\\{ 2,3,4,5\\\},\\\{ 2,3,4,6\\\},\\\{ 2,3,5,6\\\},\\\{ 2,4,5,6\\\},\\\{ 3,4,5,6\\\},\cr
      \\\{ 1,2,3,4,5\\\},\\\{ 1,2,3,4,6\\\},\\\{ 1,2,3,5,6\\\},\\\{ 1,2,4,5,6\\\},\\\{ 1,3,4,5,6\\\},\\\{ 2,3,4,5,6\\\} \\\}\cr
  \end{equation}
  である。最後に確率測度Pは、
  \begin{equation}
...
(2)$$ P(X\ge20) , P(20\le Y<30) $$を求めよ。 
  \begin{equation}
      P(X\ge20)=P(X=20)+P(X=21)+\cdots\cr
      =\sum_{k=20}^{\infty}P(X=k)\cr
      =\sum_{k=20}^{\infty}\frac{1}{6}\left(\frac{5}{6}\right)^k \cr
      =\left(\frac{5}{6}\right)^{20}\cr
  \end{equation} 

  \begin{equation}
      P(20\le Y<30)=\sum_{k=20}^{29}\frac{1}{6}\left(\frac{5}{6}\right)^{k-1}\cr
      =\left(\frac{5}{6}\right)^{19} - \left(\frac{5}{6}\right)^{29}\cr
  \end{equation} 
